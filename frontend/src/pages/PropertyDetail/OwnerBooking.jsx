...
const OwnerBooking = ({ property, token }) => {
  ...
  return (
    <OwnerBookingContainer>
      {showConfirmationPopup && currentReservation && (
        <PopupOverlay>
          <PopupContainer>
            <PopupHeader>
              <PopupTitle>Confirm Your Reservation</PopupTitle>
              <CloseButton onClick={() => setShowConfirmationPopup(false)}>
                <BiX />
              </CloseButton>
            </PopupHeader>
            
            <PopupSection>
              <PopupSectionTitle>Reservation Details</PopupSectionTitle>
              <ReservationCard color={currentReservation.color?.border}>
                <div style={{ marginBottom: '0.75rem' }}>
                  <strong>{property.name}</strong>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
                  <div>
                    <div style={{ fontSize: '0.85rem', color: '#aaa', marginBottom: '0.25rem' }}>Arrival</div>
                    <div>{currentReservation.arrival.toLocaleDateString()}</div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', margin: '0 1rem' }}>
                    <span style={{ color: '#aaa' }}>→</span>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.85rem', color: '#aaa', marginBottom: '0.25rem' }}>Departure</div>
                    <div>{currentReservation.departure.toLocaleDateString()}</div>
                  </div>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <div>
                    <div style={{ fontSize: '0.85rem', color: '#aaa', marginBottom: '0.25rem' }}>Nights</div>
                    <div>{currentReservation.nights}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.85rem', color: '#aaa', marginBottom: '0.25rem' }}>Elara</div>
                    <div>{currentReservation.tokens.toFixed(4)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.85rem', color: '#aaa', marginBottom: '0.25rem' }}>Approx. Cost</div>
                    <div>{formatCurrency(currentReservation.totalCost)}</div>
                  </div>
                </div>
              </ReservationCard>
            </PopupSection>
              ...
              <PaymentMethodsContainer>
                ...
                >
                  ...
                  <PaymentMethodDetails>
                    <PaymentMethodName>Loaf Elara</PaymentMethodName>
      ...
      <ExplanationSection>
        <ExplanationTitle>
          <BiInfoCircle size={24} /> Property Reservation System
        </ExplanationTitle>
        <ExplanationText>
          As a LOAF home owner, you have exclusive rights to reserve your property at an owner's rate for private use,
          gatherings, or stays. From a single day to extended stays, enjoy the flexibility of booking your property
          when available.
        </ExplanationText>
        
        <InfoBox>
          <InfoText>
            <strong>Flexible Payment Options:</strong> Pay using tokens from any property holding, platform deposits, fiat currency, or cryptocurrency.
          </InfoText>
        </InfoBox>
        
        <BenefitsGrid>
          <BenefitCard>
            <BenefitTitle><BiCheck size={20} /> Owner's Rate</BenefitTitle>
            <BenefitText>
              Access special owner's rates when you hold at least 0.1 tokens in the property.
            </BenefitText>
          </BenefitCard>
          
          <BenefitCard>
            <BenefitTitle><BiCheck size={20} /> Multiple Payment Methods</BenefitTitle>
            <BenefitText>
              Choose from tokens, fiat, or crypto payment options for maximum convenience.
            </BenefitText>
          </BenefitCard>
          
          <BenefitCard>
            <BenefitTitle><BiCheck size={20} /> Flexible Booking</BenefitTitle>
            <BenefitText>
              Book your property for any duration - from single day events to extended vacation stays.
            </BenefitText>
          </BenefitCard>
          
          <BenefitCard>
            <BenefitTitle><BiCheck size={20} /> Priority Access</BenefitTitle>
            <BenefitText>
              Enjoy priority booking windows and special access to your property's calendar.
            </BenefitText>
          </BenefitCard>
        </BenefitsGrid>
      </ExplanationSection>
      ...
      <BookingSection>
        ...
        <BookingGrid>
          ...
          <BookingDetailsContainer>
                ...
                <PaymentOptions>
                  ...
                  >
                    ...
                    <PaymentOptionContent>
                      <PaymentOptionTitle>Pay with Elara</PaymentOptionTitle>
                      <PaymentOptionDescription>
                        Use your LOAF Elara as payment. Elara will be removed from circulation.
                      </PaymentOptionDescription>
                    </PaymentOptionContent>
                  </PaymentOption>
                  ...
                  >
                    ...
                    <PaymentOptionContent>
                      <PaymentOptionTitle>Elara as Collateral</PaymentOptionTitle>
                      <PaymentOptionDescription>
                        Lock Elara as collateral during your reservation period. Elara returned after your stay.
                      </PaymentOptionDescription>
                    </PaymentOptionContent>
                  </PaymentOption>
                </PaymentOptions>
              ...
              {selectedDates.length === 2 && (
                <>
                  ...
                  <SummaryRow>
                    ...
                    <SummaryValue>
                      {calculateMarketRateTokensPerDay().toFixed(4)} Elara
                    ...
                    <SummaryLabel>
                      ...
                      <TooltipContainer>
                        ...
                        <Tooltip className="tooltip">
                          Owners are classified as those who hold above 0.1% of the property or 0.1 Elara in the property. Owners do not have to pay with Elara to access this rate.
                        </Tooltip>
                      </TooltipContainer>
                      <div style={{ fontSize: '0.75rem', color: 'rgba(212, 175, 55, 0.8)', marginTop: '4px' }}>
                        Your Holdings: {userTokenHoldings.toFixed(2)} Elara
                      </div>
                    </SummaryLabel>
                    <SummaryValue>
                      {tokensPerDay.toFixed(4)} Elara
                      <div style={{ fontSize: '0.85rem', color: 'rgba(255, 255, 255, 0.6)', marginTop: '2px' }}>
                  ...
                  <TotalRow>
                    ...
                    <SummaryValue isBold={true}>
                      <span style={{ fontSize: '1.05rem', fontWeight: '600' }}>{calculateApplicableTokensNeeded().toFixed(4)} Elara</span>
              ...
              {dateRanges.length > 0 && (
                <>
                  ...
                  <TotalRow>
                    ...
                    <TotalValue>
                      <span style={{ fontSize: '1.05rem', fontWeight: '600' }}>{calculateTotalTokens().toFixed(4)} Elara</span>
                      <div style={{ fontSize: '0.85rem', color: 'rgba(255, 255, 255, 0.7)', marginTop: '2px' }}>
            ...
            {dateRanges.length > 0 && (
              <BookingButton onClick={() => setIsPaymentPopupOpen(true)}>
                Confirm Reservation
              </BookingButton>
            )}
          </BookingDetailsContainer>
      ...
      {/* Only render PaymentPopup when needed and when there are date ranges */}
      {isPaymentPopupOpen && dateRanges && dateRanges.length > 0 && (
        <div id="payment-popup-container">
          <PaymentPopup
            isOpen={true}
            ...
            selectedDates={[
              dateRanges[0].arrival,
              dateRanges[0].departure
            ]}
            totalCost={dateRanges[0].tokens || 0}
            isOwnerRate={userTokenHoldings >= 0.1}
            tokenPrice={tokenPrice || 0}
            ownerRate={dateRanges[0].tokensPerDay || 0}
            marketRate={calculateMarketRatePerDay() || 0}
            userTokenHoldings={userTokenHoldings || 0}
