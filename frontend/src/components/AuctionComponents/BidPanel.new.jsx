...
const BidPanel = ({ clearingPrice, userBids, onPlaceBid, totalTokens }) => {
  ...
  // Calculate property value based on bid price (50,000 tokens per property)
  const calculatedPropertyValue = bidPrice * 50000;
      ...
      <form onSubmit={handleSubmit}>
        ...
        <BidSummary>
          <SummaryRow>
            ...
            <SummaryValue>${bidPrice.toFixed(2)} per token</SummaryValue>
          </SummaryRow>
          <SummaryRow>
          ...
          <SummaryRow>
            ...
            <SummaryValue>${(bidPrice * 50000).toFixed(2)}</SummaryValue>
          </SummaryRow>
          <SummaryRow>
        ...
        <ImportantNote>
          Remember: You'll pay the clearing price (${clearingPrice.toFixed(2)}) per token, not your bid price
        </ImportantNote>
          ...
          <BidTable>
            ...
            {userBids.map((bid, index) => (
              <BidTableRow key={bid.id}>
                <BidTableCell className="price">${bid.price.toFixed(2)}</BidTableCell>
